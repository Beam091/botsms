        ...
        if (phone == None or amount == None):
            ...
            try:
                ...
                if (amount > AMOUNT):
                    ...
                    await ctx.send(f"> แจ้งเตือน : กรุณาใส่จำนวนไม่เกิน {str(AMOUNT)}",delete_after=5)
                    ...
                    await ctx.send(f"> เริ่มยิงเบอร์ : {phone} จำนวนเวลา : {amount} นาที",delete_after=5)

                    await ctx.send("BITKUB COMMUNITY",delete_after=5)
                ...
                await ctx.send("> แจ้งเตือน : ใส่จำนวนไม่ถูกต้อง",delete_after=5)
